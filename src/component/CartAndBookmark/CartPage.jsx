...
const CartPage = () => {
  ...
  const handleProceedToCheckout = async () => {
    ...
    try {
      ...
      await axios.post("http://localhost:3000/bookNow", { bookings });
  ...
  return (
    <Box sx={{ padding: { xs: "10px", sm: "20px" }, maxWidth: "1100px", margin: "auto", textAlign: "center" }}>
      {isLoggedIn ? (
        <>
          ...
          {addCart.length > 0 ? (
            <>
              {addCart.map((stay) => (
                <Card key={stay.id} sx={{ marginBottom: "15px", display: "flex", flexDirection: { xs: "column", sm: "row" }, textAlign: "left" ,bgcolor:"#f4f3f3"}}>
                  <CardMedia
                    component="img"
