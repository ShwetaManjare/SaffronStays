...
const TentsContext = ({ children }) => {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:3000/tents")
            .then((resp) => {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:3000/homestays")
            .then((resp) => {
    ...
    useEffect(() => {
        axios.get("http://localhost:3000/farmhouses")
            .then((resp) => {
    ...
    useEffect(() => {
        axios.get("http://localhost:3000/cottages")
            .then((resp) => {
    ...
    useEffect(() => {
        axios.get("http://localhost:3000/treehouses")
            .then((resp) => {
    ...
    return (
        <staysContext.Provider value={{
            ...
            bookingData, setBookingData, cartCount, setCartCount
        }}>
            {children}
