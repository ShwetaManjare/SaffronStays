      ...
      datasets: [
        {
          ...
          backgroundColor: [
            ...
            "rgba(75, 192, 192, 2)",   // Green  
            "rgba(153, 102, 255, 8)",  // Purple  
            "rgba(255, 159, 64, 2)",   // Orange  
            "rgba(0, 128, 128, 2)",    // Teal  
            "rgba(128, 0, 255, 2)",    // Purple  
            "rgba(0, 255, 127, 2)"     // Spring Green
          ],
          borderColor: [
            "rgba(255, 99, 132, 1)",
            "rgba(54, 162, 235, 1)",
  ...
  return isAdminLoggedIn ? (
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
      ...
      sx={{ 
        ...
        height: "50px" // Reduced AppBar height
      }}
    >
      <Toolbar sx={{ minHeight: "50px !important", padding: "4px 16px" }}>
        ...
        <Typography
          ...
          sx={{ 
            ...
            color: "#fff",
            fontSize: "1.2rem",
            flexGrow: 1, // Pushes the button to the right
        ...
        {/* Space between Typography and Logout Button */}
        <Box sx={{ width: "50px" }} /> 
